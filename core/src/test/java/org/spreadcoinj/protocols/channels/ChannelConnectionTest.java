...
import org.spreadcoinj.testing.TestWithWallet;
import org.spreadcoinj.utils.Threading;
import org.spreadcoinj.wallet.WalletFiles;
...
import static org.spreadcoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.spreadcoinj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
