...
import org.spreadcoinj.store.PostgresFullPrunedBlockStore;
...
public class PostgresFullPrunedBlockChainTest extends AbstractFullPrunedBlockChainTest
{
    ...
    private static final String DB_NAME = "spradcoinj_test";
    private static final String DB_USERNAME = "spreadcoinj";
