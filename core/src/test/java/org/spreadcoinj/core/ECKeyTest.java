...
import org.spreadcoinj.crypto.EncryptedData;
...
import org.spreadcoinj.wallet.Protos.ScryptParameters;
...
import static org.spreadcoinj.core.Utils.reverseBytes;
...
public class ECKeyTest {
    ...
    public void sValue() throws Exception {
        ...
        final ECKey.ECDSASignature duplicate = new ECKey.ECDSASignature(sigs.get(0).r, sigs.get(0).s, sigs.get(0).headerByte);
    ...
    public void testSignatures() throws Exception {
        ...
        byte[] output = key.sign(Sha256Hash.ZERO_HASH).encodeToCompact();
        assertTrue(key.verify(Sha256Hash.ZERO_HASH.getBytes(), output));

        // Test interop with a signature from elsewhere.
        byte[] sig = HEX.decode(
                "1fcfd454a1215fdea463201a7a32c146c1cec54b60b12d47e118a2add41366cec63e7875d23cc80f958e45298bb8369d4422acfbc1c317353eebe02c89206b3e73");
    ...
    public void verifyMessage() throws Exception {
        ...
        Address expectedAddress = new Address(MainNetParams.get(), "SQqPUDArpjdjJnkLvbs3rM4Vhc9XwBMQtw");
