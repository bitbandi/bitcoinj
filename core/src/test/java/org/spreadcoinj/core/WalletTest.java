...
import org.spreadcoinj.signers.StatelessTransactionSigner;
...
import org.spreadcoinj.testing.*;
import org.spreadcoinj.utils.ExchangeRate;
import org.spreadcoinj.utils.Fiat;
...
import static org.spreadcoinj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: spreadcoinj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("spreadcoinj-unit-test", null);
