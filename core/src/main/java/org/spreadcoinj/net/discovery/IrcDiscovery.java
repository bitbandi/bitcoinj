...
import org.spreadcoinj.core.AddressFormatException;
import org.spreadcoinj.core.Base58;
...
public class IrcDiscovery implements PeerDiscovery {
    ...
    public InetSocketAddress[] getPeers(long timeoutValue, TimeUnit timeoutUnit) throws PeerDiscoveryException {
        ...
        try {
            ...
            // spreadcoinj but not match the standard nick format, so full peers don't try and connect to us.
