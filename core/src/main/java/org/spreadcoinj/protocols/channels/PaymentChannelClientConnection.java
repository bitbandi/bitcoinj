...
import org.spreadcoinj.net.NioClient;
import org.spreadcoinj.net.ProtobufParser;
...
public class PaymentChannelClientConnection {
     ...
     * connection is open. The server is requested to keep the channel open for {@link org.spreadcoinj.protocols.channels.PaymentChannelClient#DEFAULT_TIME_WINDOW}
