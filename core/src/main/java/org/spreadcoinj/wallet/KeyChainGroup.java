...
import org.spreadcoinj.crypto.ChildNumber;
import org.spreadcoinj.crypto.DeterministicKey;
import org.spreadcoinj.crypto.KeyCrypter;
...
/**
 * <p>A KeyChainGroup is used by the {@link org.spreadcoinj.core.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.spreadcoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.spreadcoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.spreadcoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
