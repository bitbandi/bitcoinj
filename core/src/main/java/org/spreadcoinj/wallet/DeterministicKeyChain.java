/**
 * Copyright 2013 The spreadcoinj developers.
 *
...
import org.spreadcoinj.core.BloomFilter;
 ...
 * {@link org.spreadcoinj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.spreadcoinj.crypto.MnemonicCode},
 ...
 * {@link org.spreadcoinj.crypto.DeterministicKey#serializePubB58()}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.spreadcoinj.crypto.DeterministicKey#deserializeB58(org.spreadcoinj.crypto.DeterministicKey, String)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.spreadcoinj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.spreadcoinj.crypto.DeterministicHierarchy} and
 * {@link org.spreadcoinj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from spreadcoinj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.spreadcoinj.crypto.DeterministicKey)}
