...
package org.spreadcoinj.kits;

import org.spreadcoinj.core.*;
import org.spreadcoinj.net.discovery.DnsDiscovery;
import org.spreadcoinj.protocols.channels.StoredPaymentChannelClientStates;
import org.spreadcoinj.protocols.channels.StoredPaymentChannelServerStates;
...
import org.spreadcoinj.wallet.Protos;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV spreadcoinj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit spreadcoinj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing spreadcoinj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * block sync faster for new users - please refer to the documentation on the spreadcoinj website for further details.
     */
