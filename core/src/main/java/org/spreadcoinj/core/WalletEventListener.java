...
import org.spreadcoinj.wallet.KeyChainEventListener;
...
public interface WalletEventListener extends KeyChainEventListener {
     ...
     * the object retrieved via {@link org.spreadcoinj.core.Transaction#getConfidence()}. It's safe to modify the
