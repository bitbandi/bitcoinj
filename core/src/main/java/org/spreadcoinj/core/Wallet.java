...
import org.spreadcoinj.signers.LocalTransactionSigner;
import org.spreadcoinj.signers.MissingSigResolutionSigner;
import org.spreadcoinj.signers.TransactionSigner;
import org.spreadcoinj.store.UnreadableWalletException;
import org.spreadcoinj.store.WalletProtobufSerializer;
import org.spreadcoinj.utils.BaseTaggableObject;
import org.spreadcoinj.utils.ExchangeRate;
import org.spreadcoinj.utils.ListenerRegistration;
import org.spreadcoinj.utils.Threading;
import org.spreadcoinj.wallet.*;
import org.spreadcoinj.wallet.Protos.Wallet.EncryptionType;
import org.spreadcoinj.wallet.WalletTransaction.Pool;
 ...
 *
 * <p>To learn more about this class, read <b><a href="https://spreadcoinj.github.io/working-with-the-wallet">
 ...
 * other objects, see the <a href="https://spreadcoinj.github.io/getting-started">Getting started</a> tutorial
 * on the website to learn more about how to set everything up.</p>
 *
 * <p>Wallets can be serialized using either Java serialization - this is not compatible across versions of spreadcoinj,
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.spreadcoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag, TransactionBag {
     ...
     * {@link org.spreadcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.spreadcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.spreadcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.spreadcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.spreadcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.spreadcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.spreadcoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.spreadcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.spreadcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.spreadcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.spreadcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.spreadcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.spreadcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of spreadcoinj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.spreadcoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.spreadcoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.spreadcoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.spreadcoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.spreadcoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.spreadcoinj.crypto.KeyCrypter,
     ...
     * {@link org.spreadcoinj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.spreadcoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.spreadcoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.spreadcoinj.signers.TransactionSigner.MissingSignatureException}
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link org.spreadcoinj.core.Wallet#getBalance()} - the fees required
        ...
        /**
         * If not null, the {@link org.spreadcoinj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.spreadcoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.spreadcoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
     ...
     * {@link org.spreadcoinj.core.PeerFilterProvider} interface and generally should not be used directly by apps.
