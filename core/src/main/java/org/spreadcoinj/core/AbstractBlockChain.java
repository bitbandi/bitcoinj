 ...
 * the lightweight SPV mode, a {@link org.spreadcoinj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.spreadcoinj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
...
public abstract class AbstractBlockChain {
    ...
    private boolean add(Block block, boolean tryConnecting,
        ...
        try {
            ...
            // article here for more details: http://code.google.com/p/spreadcoinj/wiki/SecurityModel
            try {
                block.verifyHeader();
