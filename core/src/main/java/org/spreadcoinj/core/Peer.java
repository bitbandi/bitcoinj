 ...
 * {@link org.spreadcoinj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.spreadcoinj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.spreadcoinj.net.NioClientManager#openConnection(java.net.SocketAddress, org.spreadcoinj.net.StreamParser)}
     * or
     * {@link org.spreadcoinj.net.NioClient#NioClient(java.net.SocketAddress, org.spreadcoinj.net.StreamParser, int)}.</p>
     *
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // spreadcoinj is a client mode implementation. That means there's not much point in us talking to other client
     ...
     * Once the pong is received the value returned by {@link org.spreadcoinj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.spreadcoinj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.spreadcoinj.core.Peer#ping()} has never
