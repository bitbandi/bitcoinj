...
public class BlockChain extends AbstractBlockChain {
     ...
     * </p>
     *
     * <p>For the store, you should use {@link org.spreadcoinj.store.SPVBlockStore} or you could also try a
     * {@link org.spreadcoinj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
