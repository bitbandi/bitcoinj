 ...
 * Note that an implementer is responsible for calling {@link PeerGroup#recalculateFastCatchupAndFilter(org.spreadcoinj.core.PeerGroup.FilterRecalculateMode)}
...
public interface PeerFilterProvider {
     ...
     * possible for the {@link org.spreadcoinj.net.FilterMerger} to request the counts of a bunch of providers
