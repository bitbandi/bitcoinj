...
import org.spreadcoinj.crypto.DRMWorkaround;
import org.spreadcoinj.net.BlockingClientManager;
import org.spreadcoinj.net.ClientConnectionManager;
import org.spreadcoinj.net.FilterMerger;
import org.spreadcoinj.net.NioClientManager;
import org.spreadcoinj.net.discovery.PeerDiscovery;
import org.spreadcoinj.net.discovery.PeerDiscoveryException;
import org.spreadcoinj.net.discovery.TorDiscovery;
import org.spreadcoinj.script.Script;
import org.spreadcoinj.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
    ...
    private volatile int vMinRequiredProtocolVersion = Block.MIN_PROTOCOL_VERSION;
     ...
     *         Use {@link org.spreadcoinj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.spreadcoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.spreadcoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.spreadcoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link org.spreadcoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.spreadcoinj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a spreadcoinj based app running in SPV mode to fully validating security.
     */
