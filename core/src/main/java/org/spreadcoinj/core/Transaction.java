...
import static org.spreadcoinj.core.Utils.*;
 ...
 * <a href="http://code.google.com/p/spreadcoinj/wiki/WorkingWithTransactions">"Working with transactions"</a> in the
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, org.spreadcoinj.script.Script, ECKey, org.spreadcoinj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], org.spreadcoinj.core.Transaction.SigHash, boolean)}
