...
/**
 * The following example shows how to use the by spreadcoinj provided WalletAppKit.
 * The WalletAppKit class wraps the boilerplate (Peers, BlockChain, BlockStorage, Wallet) needed to set up a new SPV spreadcoinj app.
 * 
...
public class Kit {
    ...
    public static void main(String[] args) {
        ...
        // spreadcoinj is working a lot with the Google Guava libraries. The WalletAppKit extends the AbstractIdleService. Have a look at the introduction to Guava services: https://code.google.com/p/guava-libraries/wiki/ServiceExplained
        kit.startAsync();
        kit.awaitRunning();

        // To observe wallet events (like coins received) we implement a EventListener class that extends the AbstractWalletEventListener spreadcoinj then calls the different functions from the EventListener class
